                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('books.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="isbn" class="block mt-1 w-full" type="text" name="isbn" :value="old('isbn')" required autocomplete="isbn" />
                        ...
                        <div class="block mt-6">
                            <label for="available" class="inline-flex items-center">
                                <input id="available" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" name="available" value="1" {{ old('available', true) ? 'checked' : '' }}>
